      ...
      for (let i = 0; i < assets.length; i++) {
        ...
        if (asset.isMarkup && asset.markupBlob) {
          ...
          const downloadUrl = isExternalUrl
            // For external (AI) URLs, prefer a high-quality print profile so downloads are crisp and sizeable.
            // This re-encodes to a high-quality JPG and best-effort targets >= 2MB when possible.
            ? `/api/external-image?url=${encodeURIComponent(asset.url)}&profile=print`
